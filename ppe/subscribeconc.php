...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["subMail"]))) {
        ...
        if ($stmt = $mysqli->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                echo ('<div style="position: absolute; bottom: 2px;">execute fail uid Quelque chose s\'est mal passé, réessayer plus tard.</div>');
            }
        }
        // Close statement
        $stmt->close();
    ...
    if ($req = $mysqli->prepare($sql2)) {
        ...
        if ($req->execute()) {
            ...
            echo ('<div style="position: absolute; bottom: 2px;">execute fail conc Quelque chose s\'est mal passé, réessayer plus tard.</div>');
        }
    } else {
        echo ('<div style="position: absolute; bottom: 2px;"> prepare fail concQuelque chose s\'est mal passé, réessayer plus tard.</div>');
    ...
    <form action="" method="post">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4 offset-md-4">
                ...
                <select class="custom-select" name="subConc">
                    <option value="1">Oui</option>
                </select>
            </div>

            <div class="form-row" id="concinfo">
